...
define('OW_URL_HOME', 'http://ec2-52-26-104-96.us-west-2.compute.amazonaws.com/');

define('OW_DB_HOST', 'localhost');
define('OW_DB_PORT', null);
define('OW_DB_USER', 'fanrightadmin');
define('OW_DB_PASSWORD', 'bluetwo1223');
define('OW_DB_NAME', 'fanright');
...
define('OW_PASSWORD_SALT', '556fb25f80e24');
